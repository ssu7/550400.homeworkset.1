...
\noindent To produce the two branches each with the desired commit history the following GIT Bash commands can be executed:
...
\noindent The following figure represent the commit history graph when on the \texttt{master} branch:

\begin{figure}[h!]
\begin{center}
\includegraphics[width=3in]{Koala.jpg}
\end{center}
...
\begin{figure}[h!]
\begin{center}
\includegraphics[width=3in]{Lighthouse.jpg}
\end{center}
...
\end{center} 
\newline The follwing GIT Bash commands will produce what the problem asks for:
\begin{lstlisting}
